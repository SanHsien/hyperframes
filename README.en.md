# HyperFrames (English Mirror)

> [!NOTE]
> **Fork 說明 / Fork Notice**:
> This is a Windows-first maintenance fork of [heygen-com/hyperframes](https://github.com/heygen-com/hyperframes) (Apache-2.0) maintained by [@SanHsien](https://github.com/SanHsien).
> 繁體中文主要維護入口請見 [README.md](README.md)；Fork 維護方針與決策請見 [FORK.md](FORK.md)。
> 本機 Windows 原生初始化請跑 pwsh -NoProfile -File tools\bootstrap_dev.ps1。
